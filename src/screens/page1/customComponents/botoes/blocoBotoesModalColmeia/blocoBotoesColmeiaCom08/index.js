...
function BlocoBotoesColmeiaCom08(props) {
  ...
  const modalContent07 = {
    title: {
      titleContent: "Título 7 modal",
      tagTitle: "5",
      titleClassName: "",
    },
    images: {
  ...
  const modalContent08 = {
    title: {
      titleContent: "Título 8 modal",
      tagTitle: "5",
      titleClassName: "",
    },
    images: {
    ...
    <Fragment>
      <Col xs="12" sm="6">
        <Title
          typeH="4"
          className=""
          content={<Fragment>Primeira Linha = 3</Fragment>}
        />

        <ColmeiaWrapper className="i3">
          <ColmeiaItem
          ...
          />
          <ColmeiaItem
            modalContent={modalContent07}
            colmeiaName="7"
            breakContent="md"
          />
          <ColmeiaItem
            modalContent={modalContent08}
            colmeiaName="8"
            breakContent="md"
          />
        </ColmeiaWrapper>
...
export default BlocoBotoesColmeiaCom08;
